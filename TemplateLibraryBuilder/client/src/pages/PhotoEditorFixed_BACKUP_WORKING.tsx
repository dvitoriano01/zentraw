...
export default function PhotoEditor() {
  ...
  const [activePropertiesTab, setActivePropertiesTab] = useState<'character' | 'paragraph' | 'textfx' | 'properties'>('properties');
                              ...
                              {(provided) => (
                                ...
                                >
                                  <div className="flex-1 min-w-0">
                                    <div className="truncate text-gray-200">{layer.name}</div>
