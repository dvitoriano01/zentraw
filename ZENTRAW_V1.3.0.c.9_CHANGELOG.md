...
console.log('🔍 RENDERIZANDO PAINEL DIREITO - activePropertiesTab:', activePropertiesTab);
console.log('🏷️ RENDERIZANDO TABSLIST - abas disponíveis: Properties, Adjustments, Libraries');
