"""
Zentraw 3D Visualizer V1.4.0.a.8.1 - HOTFIX BLENDER 4.5+ COMPATIBILITY
...
print("🎯 V1.4.0.a.8.1 - HOTFIX BLENDER 4.5+ INICIADO")
...
print(f"   ⚡ Engine: {RENDER_ENGINE} (Eevee Next padrão - Blender 4.5+)")
