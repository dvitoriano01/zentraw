/**
 * TextPropertiesPanel v1.3.0.c.3 - VERSÃO ESTÁVEL RESTAURADA
 * Sistema de propriedades de texto com fontes Freepik organizadas
 */
...
const FONT_SIZES = [8, 9, 10, 11, 12, 14, 16, 18, 20, 22, 24, 26, 28, 32, 36, 40, 44, 48, 54, 60, 66, 72];
...
export function TextPropertiesPanel({ selectedObject, onUpdateText, availableFonts: propAvailableFonts }: TextPropertiesProps) {
  ...
  // Use fonts passed as prop or fallback
  ...
  const updateProperty = (property: string, value: any) => {
    ...
    if (property === 'fontFamily') {
      ...
      if (selectedFont) {
        console.log(`🎨 Applying font: ${selectedFont.label}`);
        onUpdateText({ 
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1">
        ...
        <TabsContent value="character" className="mt-4 px-4 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={textProperties.fontFamily} onValueChange={(value) => updateProperty('fontFamily', value)}>
              ...
              <SelectContent className="bg-[#2a2a2a] border-gray-600 max-h-60">
                {allFonts.length > 0 ? (
                  allFonts.map((font) => (
                    <SelectItem key={font.value} value={font.value} className="text-xs hover:bg-[#3a3a3a] focus:bg-[#3a3a3a]">
          ...
          <div className="space-y-2">
            ...
            <Select value={textProperties.fontSize.toString()} onValueChange={(value) => updateProperty('fontSize', parseInt(value))}>
              <SelectTrigger className="w-full bg-[#2a2a2a] border-gray-600 text-white">
                <SelectValue />
              </SelectTrigger>
              <SelectContent className="bg-[#2a2a2a] border-gray-600 max-h-60">
